...
function ThreadDetail({ id, owner, title, body, category, createdAt, upVotesBy, downVotesBy, onVoteThread }) {
  ...
  return (
    <div className="flex flex-col gap-2 p-4 max-w-lg rounded-lg bg-neutral-800 text-neutral-100">
