...
function LoginInput({ login }: {login: (payload: LoginPayload) => void}) {
    ...
    return (
        <form className="max-w-md mx-auto rounded-lg shadow-lg">
            ...
            <button className="bg-neutral-700 text-neutral-300 hover:bg-neutral-600 w-full px-4 py-2 rounded-md" type="button" onClick={() => login({ email, password })}>Login</button>
        </form>
    );
}
